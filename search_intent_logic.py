...
_property_type_map = {
    ...
    'دوبلكسات': 'دوبلكس', 'روفات': 'روف', 'رووف': 'روف', 'ملاحق': 'روف', 'استراحات': 'استراحة', 'مخازن': 'مستودع', 'مستودعات': 'مستودع', 'ورش': 'مستودع', 'معارض': 'محل تجاري', 'عمارات': 'عمارة', 'مباني': 'عمارة', 'مباني تجارية': 'مبنى تجاري', 'عمارات تجارية': 'مبنى تجاري', 'عيادات': 'عيادة', 'صيدليات': 'عيادة', 'مستوصف': 'عيادة', 'مستوصفات': 'عيادة', 'عقارات تجارية': 'تجاري', 'عقارات استثمارية': 'تجاري', 'قصور': 'قصر', 'مخيمات': 'مخيم',
}
...
_property_type_map.update({
    ...
    'استوديو': 'ستوديو', 'استديو': 'ستوديو', 'ستوديو': 'ستوديو', 'استديوهات': 'ستوديو',
...
def _apply_dynamic_regex(padded: str, tags: set) -> str:
    ...
    if m_edge:
        val = m_edge.group(1)
        mapping_edge = {'تسوية': 'طابق التسوية', 'تسويه': 'طابق التسوية', 'شبه ارضي': 'طابق شبه أرضي', 'شبه أرضي': 'طابق شبه أرضي', 'روف': 'روف', 'ملحق': 'ملحق'}
    ...
    if m_floor:
        val = m_floor.group(1)
        mapping = {'ارضي': 'الطابق الأرضي', 'اول': '1', 'ثاني': '2', 'ثالث': '3', 'رابع': '4', 'خامس': '5', 'سادس': '6', 'سابع': '7', 'ثامن': '8', 'تاسع': '9', 'عاشر': '10', 'اخير': '+7'}
