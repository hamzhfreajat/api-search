...
_floor_map = {
    'تسوية': 'floor:طابق التسوية', 'التسوية': 'floor:طابق التسوية', 'طابق التسوية': 'floor:طابق التسوية',
    'شبه ارضي': 'floor:طابق شبه أرضي', 'شبة ارضي': 'floor:طابق شبه أرضي', 'طابق شبه ارضي': 'floor:طابق شبه أرضي',
    'الطابق الأرضي': 'floor:الطابق الأرضي', 'ارضي': 'floor:الطابق الأرضي', 'طابق ارضي': 'floor:الطابق الأرضي',
    'الطابق الاول': 'floor:1', 'طابق اول': 'floor:1', 'الاول': 'floor:1', 'الطابق الثاني': 'floor:2', 'طابق ثاني': 'floor:2', 'الثاني': 'floor:2',
    'الطابق الثالث': 'floor:3', 'طابق ثالث': 'floor:3', 'الثالث': 'floor:3', 'الطابق الرابع': 'floor:4', 'طابق رابع': 'floor:4', 'الرابع': 'floor:4',
    'الطابق الخامس': 'floor:5', 'طابق خامس': 'floor:5', 'الخامس': 'floor:5', 'الطابق السادس': 'floor:6', 'طابق سادس': 'floor:6', 'السادس': 'floor:6',
    'الطابق السابع': 'floor:7', 'طابق سابع': 'floor:7', 'السابع': 'floor:7',
}
...
_rent_period_map = {
    ...
    'اسبوعي': 'rent_duration:أسبوعي',
}

_payment_map = {
    'بالتقسيط بدون مقدم': 'payment_method:أقساط', 'بالتقسيط بدون فوايد': 'payment_method:أقساط', 'تقسيط بدون مقدم': 'payment_method:أقساط',
    'تقسيط بدون فوايد': 'payment_method:أقساط', 'تقسيط': 'payment_method:أقساط', 'بالتقسيط': 'payment_method:أقساط',
    'اقساط': 'payment_method:أقساط', 'بالاقساط': 'payment_method:أقساط', 'بالقسط': 'payment_method:أقساط', 'قسط': 'payment_method:أقساط',
    'كاش': 'payment_method:كاش', 'نقدا': 'payment_method:كاش', 'كاش واقساط': 'payment_method:كاش أو أقساط',
}

_tenant_map = {
    'عزاب': 'عزاب', 'عزوبيه': 'عزاب', 'للشباب': 'عزاب', 'عائلات': 'عائلات', 'عائلي': 'عائلات', 'العائلي': 'عائلات',
    'عائله': 'عائلات', 'عائلة': 'عائلات', 'عمال': 'عمال', 'للعمال': 'عمال',
}

_source_map = {
    'من المالك مباشره': 'من المالك مباشرة', 'من المالك مباشرة': 'من المالك مباشرة', 'من المالك': 'من المالك',
    'مباشره': 'من المالك مباشرة', 'بدون عموله': 'بدون عمولة', 'بدون عمولة': 'بدون عمولة',
}
