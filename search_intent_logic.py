...
_furnishing_map = {
    'مفروشه': 'مفروش کامل', 'مفروشة': 'مفروش کامل', 'مفرشه': 'مفروش کامل', 'مفرشة': 'مفروش کامل',
    'مفروش': 'مفروش کامل', 'مؤثثه': 'مفروش کامل', 'مؤثثة': 'مفروش کامل', 'مؤثث': 'مفروش کامل',
    'غير مفروشه': 'فارغ', 'غير مفروشة': 'فارغ', 'بدون فرش': 'فارغ',
}
...
_rent_period_map = {
    'يوم واحد': 'إيجار يومي', 'يومي': 'إيجار يومي', 'اليومي': 'إيجار يومي',
    'بالساعه': 'إيجار يومي', 'بالساعة': 'إيجار يومي', 'سياحي': 'إيجار يومي',
    'شهري': 'دفع شهري', 'الشهري': 'دفع شهري', 'بالشهر': 'دفع شهري', 'شهر': 'دفع شهري',
    'سنوي': 'سنوي', 'السنوي': 'سنوي', 'سنه': 'سنوي', 'سنة': 'سنوي',
    'اسبوعي': 'إيجار أسبوعي',
}
